...
As part of the curated technical support series for the hackathon, Prof. Zhenyu Yang, Research Assistant Professor of Medical Physics at DKU, led a hands-on workshop titled _On-Device Intelligence: Building Real-World AI Apps Across the Apple Ecosystem_ on April 16. The session offered participants an end-to-end journey into developing practical AI applications natively on Apple platforms, directly aligning with the core theme of Ethics and AI.
